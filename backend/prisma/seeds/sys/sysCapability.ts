...
export const initCapability = async () => {
  const data: Prisma.CapabilityCreateManyInput[] = [
    ...
    { id: 'cap-tenant-user-password-manage', code: 'tenant.user.password.manage', name: '用户密码管理', module: 'tenant', kind: 'action', builtIn: true, description: '管理员独立修改用户密码', status: 'ENABLED', createdBy: '-1', updatedBy: '-1' },
