...
export const initCapabilityApiBinding = async () => {
  const data: Prisma.CapabilityApiBindingCreateManyInput[] = [
    ...
    { id: 'binding-role-scope-read', capabilityId: 'cap-tenant-role-scope-manage', resource: 'role-scope-strategies', action: 'read', bindingMode: 'ALL_OF', method: 'GET', path: '/roles/:id/scope-strategies', createdBy: '-1', updatedBy: '-1' },
    { id: 'binding-role-scope-update', capabilityId: 'cap-tenant-role-scope-manage', resource: 'role-scope-strategies', action: 'update', bindingMode: 'ALL_OF', method: 'PUT', path: '/roles/:id/scope-strategies', createdBy: '-1', updatedBy: '-1' },
    ...
    { id: 'binding-user-password-manage', capabilityId: 'cap-tenant-user-password-manage', resource: 'users', action: 'change_password', bindingMode: 'ALL_OF', method: 'PUT', path: '/user/:id/change-password', createdBy: '-1', updatedBy: '-1' },
    ...
    { id: 'binding-scope-dimension-records-org-reference', capabilityId: 'cap-tenant-org-reference-read', resource: 'scope-dimension-records', action: 'list', bindingMode: 'ANY_OF', method: 'GET', path: '/scope-dimensions/:dimensionEntityCode/records', createdBy: '-1', updatedBy: '-1' },
    { id: 'binding-scope-dimension-records-user-auth-manage', capabilityId: 'cap-tenant-user-auth-profile-manage', resource: 'scope-dimension-records', action: 'list', bindingMode: 'ANY_OF', method: 'GET', path: '/scope-dimensions/:dimensionEntityCode/records', createdBy: '-1', updatedBy: '-1' },
    { id: 'binding-scope-dimension-records-role-scope-manage', capabilityId: 'cap-tenant-role-scope-manage', resource: 'scope-dimension-records', action: 'list', bindingMode: 'ANY_OF', method: 'GET', path: '/scope-dimensions/:dimensionEntityCode/records', createdBy: '-1', updatedBy: '-1' },
