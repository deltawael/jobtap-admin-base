...
export const initRoleTemplateCapability = async () => {
  const data: Prisma.RoleTemplateCapabilityCreateManyInput[] = [
    ...
    { templateId: 'rt-system-admin', capabilityId: 'cap-tenant-user-read' },
    { templateId: 'rt-system-admin', capabilityId: 'cap-tenant-user-manage' },
    { templateId: 'rt-system-admin', capabilityId: 'cap-tenant-user-password-manage' },
    { templateId: 'rt-system-admin', capabilityId: 'cap-tenant-role-read' },
    { templateId: 'rt-system-admin', capabilityId: 'cap-tenant-role-manage' },
    { templateId: 'rt-system-admin', capabilityId: 'cap-tenant-role-scope-manage' },
    ...
    { templateId: 'rt-tenant-admin', capabilityId: 'cap-tenant-user-password-manage' },
